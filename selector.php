...
<div class="container ">
    <div class="row">
        <div class=" row  mt-3 d-flex justify-content-center align-items-center">
            ...
            <div class=" selector col-md-4">
                <div class=" p-5 pull-left">
                    <a class="btn btn-warning btn-block" id="Button_19">
                        اجرا
                        <label id="fileSelector" for="">
                            <input type="file" name="" id="" value="file Selector" >
                        </label>
            ...
            <div class=" selector col-md-4">
                <div class=" p-5 pull-left" id="firstSelector">
                    <p>test</p>
                    <a class="btn btn-warning btn-block" id="Button_22">
                        اجرا
                    </a>
                    <div class="firstTypeSelector" >
                        <p>0</p>
                        <p>1</p>
                        <p>2</p>
                        <p>3</p>
            ...
            <div class=" selector col-md-4">
                <div class=" p-5 pull-left" id="greaterThanSelector">
